...
class LinkItemsControllerTest < ActionController::TestCase
  ...
  test "should update link_item" do
    patch :update, id: @link_item, link_item: { needs_email: @link_item.needs_email, original_url: @link_item.original_url, password: @link_item.password, short_name: @link_item.short_name }
    assert_redirected_to link_item_path(assigns(:link_item))
  end
